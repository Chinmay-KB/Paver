...
public class entryActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (stream.equals("M.Sc"))
            r5.setChecked(true);
        if (stream.equals("Int. M.Sc"))
            r7.setChecked(true);
        if (stream.equals("M.Tech"))
            r8.setChecked(true);
        if (stream.equals("Dual Degree"))
            r6.setChecked(true);
        if (stream.equals("Ph.D"))
            r9.setChecked(true);
        stream=correspond(stream);
    ...
    public String correspond(String a)
    {
        ...
        else if (a.equals("Int. M.Sc"))return "5";
        else if (a.equals("M.Tech"))return "6";
    ...
    public void uiRef()
    {
        ...
        tbrow.addView(t1v); */
            ...
            t2v.setTextColor(getResources().getColor(R.color.tableSelection));
            ...
            t3v.setText(xMain[i]);
            t3v.setTextColor(getResources().getColor(R.color.tableSelection));
            ...
            t4v.setText(xs1[i]);
            t4v.setTextColor(getResources().getColor(R.color.tableSelection));
            ...
            t5v.setText(xs2[i]);
            t5v.setTextColor(getResources().getColor(R.color.tableSelection));
            ...
            t6v.setText(xs3[i]);
            t6v.setTextColor(getResources().getColor(R.color.tableSelection));
