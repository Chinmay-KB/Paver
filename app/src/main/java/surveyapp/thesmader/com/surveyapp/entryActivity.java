    ...
    public void uiRef()
{
   ...
   stk.setStretchAllColumns(true);
    ...
    for (int i = 0; i <limit; i++) {
        ...
        t3v.setText(xMain[i]);
        t3v.setTextColor(getResources().getColor(R.color.colorPrimary));
        ...
        t4v.setText(xs1[i]);
        t4v.setTextColor(getResources().getColor(R.color.colorPrimary));
        ...
        t5v.setText(xs2[i]);
        t5v.setTextColor(getResources().getColor(R.color.colorPrimary));
        ...
        t6v.setText(xs3[i]);
        t6v.setTextColor(getResources().getColor(R.color.colorPrimary));
